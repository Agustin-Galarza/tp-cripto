...
public class LSBICodec implements StegoCodec {
    ...
    @Override
    public byte[] encode(byte[] secret, byte[] coverImage) throws SecretTooLargeException {
        return coverImage;
...
//        return stegoImage;
    ...
    public byte[] decode(byte[] imageBytes) {
        ...
        int secondPixelBlueChannel = imageBytes[i++];
